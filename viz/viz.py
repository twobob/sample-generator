...
def audio_spectrogram_image(waveform, power=2.0, sample_rate=48000):
    ...
    return show_image_list([spectrogram_image(melspec[0], title="Left", ylabel='mel bins (log freq)'),
                            spectrogram_image(melspec[1], title="Right", ylabel='mel bins (log freq)')
                            ])
